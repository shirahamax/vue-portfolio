      ...
      <v-layout row wrap justify-center>
        ...
        <v-flex xs12 sm6>
          <v-carousel :cycle="false" height="100%" class="item-carousel">
            <v-carousel-item v-for="index in 3" :key="index" :src="detail.image">
              <v-layout justify-start v-if="detail.is_sold_out">
        ...
        <v-flex xs12 sm6 class="white">
          <v-container :class="breakpoint.xs?'pt-1':''">
            ...
            <v-layout align-center>
              ...
              <div class="mr-2">
                <v-btn round small flat class="grey lighten-2 grey--text text--darken-2 ma-0" @click="pushLikeBtn">
              ...
              <v-btn round small flat class="grey lighten-2 grey--text text--darken-2 ma-0 mr-2 "
                @click="commented=!commented">
                <span class="body-2 pt-1">
                  <span v-if="commented" class="amber--text micon-comment"></span>
          ...
          <v-container>
            <v-layout row wrap justify-start align-start>
              <v-card max-height="250px" min-height="100px" width="100%" flat style="overflow-y: auto;">
...
export default {
  ...
  created () {
    ...
    this.$store.dispatch('itemModule/getItemDetail', itemId)
